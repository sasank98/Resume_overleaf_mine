...
\section{EDUCATION}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Northeastern Khoury college of Computer Science}{3.73/4 GPA}
      \vspace{3pt}
...
%        \resumeItem{Implemented a novel architecture on Stereo Cameras to compute Flow, Stereo Disparity and 3D-object detection simultaneously}
    ...
    \resumeSubheading
      {Research Assistant at Hydrodynamics Lab $|$ \textmd{\emph{Ansys, SolidWorks, Matlab}}}{Jan 2020 -- Jun 2020}
...
%            \resumeItem{Applied bundle adjustment on traingulated keypoints using GTSAM to get optimized keypoint and pose estimates}
      ...
      \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Implemented a tracking decoder on PETR-v1 model to compare results from both approaches}
          \resumeItemListEnd 
          \vspace{-15pt}
          \resumeProjectHeading
